    ...
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.'.$dataType->slug.'.update', $dataTypeContent->id) }}@else{{ route('voyager.'.$dataType->slug.'.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> Slider Title
                                <span class="panel-desc"> The title for your slider</span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Slogan
                                <span class="panel-desc"> The slogan for slider</span>
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="slogan" name="slogan" placeholder="Slogan" value="@if(isset($dataTypeContent->slogan)){{ $dataTypeContent->slogan }}@endif">
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-book"></i> Slider Description</h3>
                            <div class="panel-actions">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-image"></i> Slider Image</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="custom-form-group">
                                <div class="file-input-wrapper">
                                    <button class="custom-upload-btn uploadFile" data-type="image" id="uploadImage"><i class="fa fa-upload"></i> Upload Thumbnail</button>
                    ...
                    <div class="panel panel-bordered panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-search"></i> Advanced Option</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="toggle btn btn-primary" data-toggle="toggle" style="width: 73px; height: 29px;">
                                <input type="checkbox" @if(isset($dataTypeContent->is_featured)) {!! $dataTypeContent->is_featured ? 'checked="checked"' : '' !!}@endif name="is_featured" class="toggleswitch" data-on="YES" data-off="NO">
            ...
            <button type="submit" class="btn btn-primary pull-right">
                @if(isset($dataTypeContent->id)){{ 'Update Slider' }}@else <i class="icon wb-plus-circle"></i> Create Now @endif
            </button>
        </form>
