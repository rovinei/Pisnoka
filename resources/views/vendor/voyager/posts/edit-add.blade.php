                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    @php
                                        $categories = TCG\Voyager\Models\Category::where('model_type', 'BLOG')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tags" name="taggs">
                            </div>
                            <div class="form-group">
...
@section('javascript')
    ...
    <script>
        @php
            $post_tags = TCG\Voyager\Models\Post::existingTags()->pluck('name');
        @endphp
        var tagOptions = [
