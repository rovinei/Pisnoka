      ...
      <div class="col-md-4">
        <div class="right">
            <div class="social-icons-subnav">
                ...
                <a href="@if(Voyager::setting('site_twitter_acc')){{Voyager::setting('site_twitter_acc')}}@endif"><span class="ti-twitter"></span></a>
                <a href="@if(Voyager::setting('site_linked_acc')){{Voyager::setting('site_linked_acc')}}@endif"><span class="ti-linkedin"></span></a>
            </div>
        </div>
      </div>
